...
| Unit                        | Symbol&nbsp;&blacktriangledown; | SI Base | SI Derivation | SI Extension | SI relevant | SI Prefix | SI Exponents | Common Units | Informal Variant |
|-----------------------------|---------------------------------|---------|---------------|--------------|-------------|-----------|--------------|--------------|------------------|
| (Arc) Minute                | &#x2032;                        |         |               |              |             |           |              | x            |                  |
| Inch (quote mark)           | &#x2033;                        |         |               |              |             |           |              | x            |                  |
| (Arc) Second                | &#x2033;                        |         |               |              |             |           |              | x            |                  |
...
| Gauge Pressure (At&uuml)    | At&uuml;                        |         |               |              |             |           |              | x            |                  |
...
| Decameter                   | dam                             |         |               |              |             |           |              | x            |                  |
| Decibel                     | dB                              |         |               | x            | x           |           |              | x            |                  |
| Decibel A/C/G/Z curve       | db([ACGZ])                      |         |               | x            | x           |           |              | x            |                  |
| Dioptre                     | dpt                             |         |               | x            | x           |           |              | x            |                  |
