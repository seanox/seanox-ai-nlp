...
def test_units_01(text):
    expected = [
        ...
        Unit(label='UNIT', start=147, end=150, text='das', categories=('time',), unit='das', value=None),
        ...
        Unit(label='UNIT', start=849, end=852, text='das', categories=('time',), unit='das', value=None),
